...
class _HomeWidgetState extends State<HomeWidget> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<NoticiasRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<NoticiasRow> homeNoticiasRowList = snapshot.data!;
                                                              ...
                                                              child:
                                                                ...
                                                                updateCallback: () =>
                                                                    safeSetState(
                                                                        () {}),
                                                                child:
                                                                    MenuCadernosSuperiorWidget(
                                                                  key: Key(
                                                                    'Keyxp0_${cadernosItem.id.toString()}',
                                                                  ),
                                                                  parameter1:
                                                                      cadernosItem
                                                                          .nomecaderno,
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            noticiasItem.subtitulo.maybeHandleOverflow(
                                                                              maxChars: 100,
                                                                              replacement: '…',
                                                                            ),
                                                                            maxLines:
